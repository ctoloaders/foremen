...
// FOR-04-14 task 11.6: the `/rooms` route renders the rooms feature page
// (created by task 11.5 at `@/features/rooms/RoomsPage`). This import resolves
// once 11.5 lands; until then it is the expected wiring target.
const RoomsPage = React.lazy(() => import('@/features/rooms/RoomsPage'))
...
const MaterialCategoriesPage = React.lazy(
  () => import('@/features/material-categories/MaterialCategoriesPage')
)
const OfferPackagesPage = React.lazy(
  () => import('@/features/offer-packages/OfferPackagesPage')
)
        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                element: <SuspenseWrapper><MaterialCategoriesPage /></SuspenseWrapper>,
              },
              {
                path: 'offer-packages',
                element: <SuspenseWrapper><OfferPackagesPage /></SuspenseWrapper>,
              },
              {
                path: 'catalog/works',
