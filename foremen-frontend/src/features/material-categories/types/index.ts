...
/**
 * Returned by GET /api/material-categories (paginated).
...
/**
 * Returned by GET /api/material-categories/{id} (extended).
 * Contains all locale fields. Used for the edit form.
 */
export interface MaterialCategoryExtendedDto {
  id: number
  code: string
  nameRU: string
  namePL: string
...
export type MaterialCategoryFormMode = 'create' | 'edit'
