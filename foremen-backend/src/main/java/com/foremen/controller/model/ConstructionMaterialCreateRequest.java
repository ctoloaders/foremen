 ...
 * {@code producerId}/{@code sellerId} are optional. The material-side package dimension was collapsed
 * by FOR-05-04-UI (Requirement 5), so there is no longer any package binding on the write path. The
 * three prices are optional but, when present, must fall within
